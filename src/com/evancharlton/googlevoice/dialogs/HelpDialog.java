...
public class HelpDialog extends Dialog {
	...
	public static final int DIALOG_ID = 0xDEADBEEF;
	...
	public HelpDialog(Context context) {
		...
		aboutBtn.setOnClickListener(new View.OnClickListener() {
			public void onClick(View v) {
				AboutDialog.create(HelpDialog.this.getContext()).show();
			}
		});
	}
	...
	public static boolean injectHelp(Menu menu, char number, char letter) {
		menu.add(Menu.NONE, MENU_HELP, MENU_GROUP, R.string.help).setShortcut(number, letter).setIcon(android.R.drawable.ic_menu_help);
		return true;
	}
}
